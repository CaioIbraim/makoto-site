      ...
      <>
        ...
        <div className="flex justify-center items-center lg:justify-between p-6 border-b border-gray-300">
          ...
          <div className="flex justify-center">
            ...
            <a href="https://www.instagram.com/makotopatch/" className="mr-6 text-gray-600">
        ...
        <div className="mx-6 py-10 text-center md:text-left">
          <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="">
                 <Link href="/">
                    <Image src="/logo.jpeg" className="rounded-full cursor-pointer " width="150" height="150"/>
                </Link>
            </div>
            <div className="">
              ...
              <p className="mb-4">
              <Link href="/sobre">
                  <a href="#!" className="text-gray-600">Combos Promocionais Atacado</a>
                </Link>
               </p>
              <p className="mb-4">
              <Link href="/sobre">
                  <a href="#!" className="text-gray-600">Tabela de Preços Atacado</a>
                </Link>
               </p>
            ...
            <div className="">
              ...
              <p className="mb-4">
              <Link href="/sobre">
                  <a href="#!" className="text-gray-600">Sobre</a>
                </Link>
               </p>
            ...
            <div className="">
              ...
              <p className="flex items-center justify-center md:justify-start mb-4">
                ...
                R. Monsenhor Messias, 930 - Flamengo
                Contagem - MG
              </p>
              <p className="flex items-center justify-center md:justify-start mb-4">
        ...
        <div className="text-center p-6 bg-gray-900">
          ...
          <Link href="/">
            <span  className="text-gray-100 font-semibold cursor-pointer">
              Makoto Patches
            </span>
          </Link>
        </div>
