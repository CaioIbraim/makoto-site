      ...
      <>
                ...
                >
                  <div className="lg:inline-flex lg:flex-row lg:ml-auto lg:w-auto w-full lg:items-center items-start  flex flex-col lg:h-auto">
                    ...
                    <Link href="/login">
                      <a className="border-2 md:border-none  mt-1 lg:inline-flex lg:w-auto w-full px-3 py-2 rounded border-solid text-white font-bold items-center justify-center hover:bg-gray-600 hover:text-white">
                        Entrar
                      </a>
                    </Link>
